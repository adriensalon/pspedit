...
//             if (reqType & 0x80) {
//                 buf[0] = (u8)g_hid_protocol;
//                 return (req->wLength >= 1) ? 1 : 0;
//             }
//             return 0;
...
// static int hid_attach(int speed, void* a2, void* a3)
// {
//     (void)speed;
//     (void)a2;
//     (void)a3;
//     return 0;
// }
// static int hid_detach(int a, int b, int c)
// {
//     (void)a;
//     (void)b;
//     (void)c;
//     return 0;
// }
// static int hid_start(int size, void* args)
// {
//     (void)size;
//     (void)args;
//     return 0;
// }
// static int hid_stop(int size, void* args)
// {
//     (void)size;
//     (void)args;
//     return 0;
