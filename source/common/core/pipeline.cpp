...
template void serialize<cereal::BinaryInputArchive>(cereal::BinaryInputArchive&, pipeline_descriptor&);
template void serialize<cereal::BinaryOutputArchive>(cereal::BinaryOutputArchive&, pipeline_descriptor&);
template void serialize<cereal::JSONInputArchive>(cereal::JSONInputArchive&, pipeline_descriptor&);
template void serialize<cereal::JSONOutputArchive>(cereal::JSONOutputArchive&, pipeline_descriptor&);
