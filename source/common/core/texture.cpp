...
template void serialize<cereal::BinaryInputArchive>(cereal::BinaryInputArchive& archive, texture_descriptor& descriptor);
template void serialize<cereal::BinaryOutputArchive>(cereal::BinaryOutputArchive& archive, texture_descriptor& descriptor);
template void serialize<cereal::JSONInputArchive>(cereal::JSONInputArchive& archive, texture_descriptor& descriptor);
template void serialize<cereal::JSONOutputArchive>(cereal::JSONOutputArchive& archive, texture_descriptor& descriptor);
